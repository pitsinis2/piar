...
function createSystemUser({ id = crypto.randomUUID(), personalNumber = "", name, surname, tel, email, role = "user", qualification = 0, workmode = "none", status = "active", createdAt = new Date().toISOString() }) {
  return {
    id,
